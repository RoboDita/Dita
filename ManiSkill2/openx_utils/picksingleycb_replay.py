...
def process(episode_idx, camera_idx, traj_model_name, h5_file, json_data):
    # replay
    # get action
...
def main():
    fn = sys.argv[1]
    traj_idx = int(sys.argv[2])
    cam_idx = int(sys.argv[3])
    print("Pick model ", fn, " and trajectory ", traj_idx, " and camera ", cam_idx)
    ...
    process(traj_idx, cam_idx, fn, h5_file, json_data)
