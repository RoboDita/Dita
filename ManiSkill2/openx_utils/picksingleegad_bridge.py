...
from mani_skill2.envs.pick_and_place.pick_single import PickSingleEGADEnv
...
natural_instruction = "pick up the object and move it to the green point"
...
@register_env("PickSingleEGAD-v0-MoreCamera", max_episode_steps=200, override=True)
class PickSingleEGADMoreCameraEnv(PickSingleEGADEnv):
